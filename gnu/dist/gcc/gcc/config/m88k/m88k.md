...
(define_insn ""
  [(set (match_operand:CC 0 "register_operand" "=r")
	(rotate:CC (match_operand:CC 1 "partial_ccmode_register_operand" "r")
...
(define_split
  ...
  ""
  [(set (match_dup 4)
	(rotate:CCEVEN (match_dup 1) (match_dup 2)))
   (set (match_dup 0)
...
;	  label_num = CODE_LABEL_NUMBER (operands[2]);
;	  output_asm_insn
  ...
  "*
{
  ...
  label_num = CODE_LABEL_NUMBER (operands[3]);
...
;  output_label (CODE_LABEL_NUMBER (operands[2]));
;  return \"\";
;}"
...
(define_expand "epilogue"
  [(return)]
  "! null_prologue ()"
  "m88k_expand_epilogue (); emit_jump_insn(gen_return_internal()); DONE;")
