 ...
 * dma_cachectl() modes:
 *
 * SYNC       - invalidate I-cache; copy back D-cache but do not invalidate.
 * SYNC_INVAL - invalidate I-cache; copy back & invalidate (flush) D-cache.
 * INV        - invalidate I-cache & D-cache.
 */
